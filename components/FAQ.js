...
const FAQ = () => {
  ...
  return (
    <Container className={"mb-44 scroll-mt-10 mt-60"} id="faq">
      ...
      <section class="relative z-10 overflow-hidden bg-[transpreant] dark:bg-dark py-20 lg:py-[120px]">
        <div class="container mx-auto">
          <div class="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div class="relative p-8 bg-[#3030ed8c] rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  <div class="mb-6">
                    <input
                      type="text"
                      placeholder="Your Name"
                      class="border-stroke  bg-[#3030ed8c]  dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none"
                    />
                  </div>
                  <div class="mb-6">
                    <input
                  ...
                  <div class="mb-6">
                    <textarea
                      ...
                      class="border-stroke  bg-[#3030ed8c]  dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none"
                    ></textarea>
                  </div>
                  <div>
                    <button
